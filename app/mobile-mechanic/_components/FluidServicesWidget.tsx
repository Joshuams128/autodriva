...
export default function FluidServicesWidget() {
  useEffect(() => {
    const widget = document.getElementById('square-booking-widget2');
    if (widget) {
      const script = document.createElement('script');
      script.src = 'https://app.squareup.com/appointments/buyer/widget/h51s4wa6kn4y5h/L3JJQK4G945KD.js';
      ...
      <div className="max-w-[1140px] mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-[#777] text-[15px] leading-[1.8] max-w-2xl mx-auto">
            Choose your fluid service and select your preferred date and time for a convenient appointment at your location.
          </p>
        </div>

        <div
          id="square-booking-widget2"
